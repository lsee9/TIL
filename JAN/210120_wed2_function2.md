...
> 재귀, 포인터, opp/class를 프로그래밍 3대장이라고 할 수 있습니다. 추상적이라 처음 접한다면 많이 헷갈리는 부분입니다. 이 중 재귀에 대해 알아봅시다.
>
...
- 문제점
  ...
  - 너무 많은 함수가 호출될 경우(재귀가 깊은 경우) 메모리 스택이 넘치는 Stack overflow가 발생하거나, 프로그램 실행속도가 느려집니다.
